...
def onshore_wind_merra_wagner_nea(placements, merra_path, gwa_50m_path, globCover2009_path, output_netcdf_path=None, output_variables=None):
    ...
    globCover2009_path : str
        Path to the GlobCover raster file [3].
    ...
    wf.estimate_roughness_from_land_cover(
        path=globCover2009_path,
        source_type="globCover")
